...
export default function Attendance() {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-[30px] md:pt-[60px] pb-[100px] md:pb-[130px]">
      <h1 className="!text-[#F19CA6] text-lg !font-bold  md:text-2xl leading-[36px] mb-10">Attendance</h1>
...
Attendance.getLayout = (page: React.ReactElement) => {
  return (
    <AppLayout
      parentTab={[
        ...
        { text: 'Leave Request', url: '/employee/LeaveRequest', active: true },
      ]}
    >
      {page}
    </AppLayout>
